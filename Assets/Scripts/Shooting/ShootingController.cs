...
public class ShootingController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool isOnPauseMenu = _np != null && _np.IsPaused;
        // get mouse left click, check if ammo is more than 0 and check if "Equip" animation is finished, check if animation is done
        if (Input.GetButtonDown("Fire1") && (isOnPauseMenu || !isAmmoEmpty) && !_animator.GetCurrentAnimatorStateInfo(0).IsName("Equip") && !_animator.GetCurrentAnimatorStateInfo(0).IsName("Shoot"))
        {
