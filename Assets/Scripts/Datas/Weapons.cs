...
public class Weapons
{
    ...
    public static WeaponData OpMask() { return new WeaponData(1, 100, new float[] { -0.111f, 0.012f, 0.01f }, "OP Mask"); }

    public static WeaponData FFPMask() { return new WeaponData(2, 50, new float[] { -0.111f, 0.012f, 0.01f }, "FFP2 Mask"); }
}